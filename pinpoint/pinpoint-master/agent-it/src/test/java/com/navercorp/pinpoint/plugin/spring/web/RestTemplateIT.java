...
@Dependency({"org.springframework:spring-web:[4.1.2.RELEASE],[4.2.0.RELEASE,4.2.max],[4.3.0.RELEASE,4.3.max]", "org.apache.httpcomponents:httpclient:4.3", "io.netty:netty-all:4.1.9.Final", "org.nanohttpd:nanohttpd:2.3.1"})
