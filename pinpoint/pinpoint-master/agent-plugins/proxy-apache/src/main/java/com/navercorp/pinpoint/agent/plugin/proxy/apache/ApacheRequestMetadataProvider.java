 ...
 * @author jaehong.kim
 */
public class ApacheRequestMetadataProvider implements ProxyRequestMetadataProvider {
    @Override
    public void setup(ProxyRequestMetadataSetupContext context) {
        context.addProxyHttpHeaderType(ApacheRequestConstants.APACHE_REQUEST_TYPE);
    }
}