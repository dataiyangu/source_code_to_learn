...
public class ExceptionHandleScopedInterceptor1 implements AroundInterceptor1 {
    ...
    public ExceptionHandleScopedInterceptor1(AroundInterceptor1 interceptor, InterceptorScope scope, ExecutionPolicy policy, ExceptionHandler exceptionHandler) {
        if (interceptor == null) {
