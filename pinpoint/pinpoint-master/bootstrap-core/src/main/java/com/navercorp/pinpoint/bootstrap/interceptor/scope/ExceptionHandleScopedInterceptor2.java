...
public class ExceptionHandleScopedInterceptor2 implements AroundInterceptor2 {
    ...
    public ExceptionHandleScopedInterceptor2(AroundInterceptor2 interceptor, InterceptorScope scope, ExecutionPolicy policy, ExceptionHandler exceptionHandler) {
        if (interceptor == null) {
