...
public class ExceptionHandleScopedInterceptor3 implements AroundInterceptor3 {
    ...
    public ExceptionHandleScopedInterceptor3(AroundInterceptor3 interceptor, InterceptorScope scope, ExecutionPolicy policy, ExceptionHandler exceptionHandler) {
        if (interceptor == null) {
