...
public class AnnotationInternalNameMatcherOperandTest {
    ...
    public void base() throws Exception {
        ...
        assertTrue(operand.isConsiderMetaAnnotation());
        assertTrue(operand.match("javax/annotation/Resource"));
        assertFalse(operand.match("java.lang.Override"));

        assertEquals("javax/annotation/Resource", operand.getAnnotationInternalName());
