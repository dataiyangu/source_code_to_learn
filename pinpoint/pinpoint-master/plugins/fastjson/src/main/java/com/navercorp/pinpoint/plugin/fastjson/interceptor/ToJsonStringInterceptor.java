...
/**
 * The type To json string interceptor.
 *
 * @author Victor.Zxy
 * @version 1.8.1
 * @since 2017/07/17
 */
public class ToJsonStringInterceptor implements AroundInterceptor {
    ...
    /**
     * Instantiates a new To json string interceptor.
     *
    ...
    public void after(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        try {
            ...
            if (result instanceof String) {
                recorder.recordAttribute(FastjsonConstants.ANNOTATION_KEY_JSON_LENGTH, ((String) result).length());
            }
        } finally {
            trace.traceBlockEnd();
        }
