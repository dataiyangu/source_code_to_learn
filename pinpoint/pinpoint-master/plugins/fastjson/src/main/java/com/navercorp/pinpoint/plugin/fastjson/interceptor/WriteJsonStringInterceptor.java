...
/**
 * The type Write json string interceptor.
 *
 * @author Victor.Zxy
 * @version 1.8.1
 * @since 2017/07/17
 */
public class WriteJsonStringInterceptor implements AroundInterceptor {
    ...
    /**
     * Instantiates a new Write json string interceptor.
     *
