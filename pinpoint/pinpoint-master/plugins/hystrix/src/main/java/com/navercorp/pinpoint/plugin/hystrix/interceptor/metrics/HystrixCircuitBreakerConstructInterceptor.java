 ...
 */
public class HystrixCircuitBreakerConstructInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {
    ...
    public HystrixCircuitBreakerConstructInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
        ...
        traceContext.cacheApi(HYSTRIX_CIRCUIT_BREAKER_METHOD_DESCRIPTOR);
    }
