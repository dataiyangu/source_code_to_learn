...
public class EventLoopsSchedulerScheduleDirectInterceptor extends WorkerScheduleInterceptor {
    ...
    public EventLoopsSchedulerScheduleDirectInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
        super(traceContext, descriptor, RxJavaPluginConstants.RX_JAVA_INTERNAL);
    }
}
