 ...
 */
public final class PluginTestLogger {
...
//    private final String loggerName;
    ...
    private static void setup() {
        // TODO setup forkpluginLogger LogLevel
        // low priority
//        String logLevel = System.getProperty("pinpoint.agent.forkpluginlogger.loglevel");
//        logLevel = ???
    }


    public PluginTestLogger(String loggerName) {
...
//        this.loggerName = loggerName;
    ...
    static PluginTestLogger getLogger(String loggerName) {
        return new PluginTestLogger(loggerName);
    }
    ...
    public void debug(String msg) {
        String formatMessage = format("DEBUG ", msg, "");
