            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.agentStats = new java.util.ArrayList<TAgentStat>(_list40.size);
                TAgentStat _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new TAgentStat();
                  _elem41.read(iprot);
                  struct.agentStats.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAgentStatBatch struct) throws org.apache.thrift.TException {
      ...
      if (struct.agentStats != null) {
        oprot.writeFieldBegin(AGENT_STATS_FIELD_DESC);
        {
          ...
          for (TAgentStat _iter43 : struct.agentStats)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetAgentStats()) {
        {
          ...
          for (TAgentStat _iter44 : struct.agentStats)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.agentStats = new java.util.ArrayList<TAgentStat>(_list45.size);
          TAgentStat _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new TAgentStat();
            _elem46.read(iprot);
            struct.agentStats.add(_elem46);
          }
        }
        struct.setAgentStatsIsSet(true);
      }
