...
public class TCmdActiveThreadDumpRes implements org.apache.thrift.TBase<TCmdActiveThreadDumpRes, TCmdActiveThreadDumpRes._Fields>, java.io.Serializable, Cloneable, Comparable<TCmdActiveThreadDumpRes> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCmdActiveThreadDumpResStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCmdActiveThreadDumpResTupleSchemeFactory();

  private java.util.List<TActiveThreadDump> threadDumps; // required
  ...
  public TCmdActiveThreadDumpRes(
    java.util.List<TActiveThreadDump> threadDumps)
  {
    this();
  ...
  public TCmdActiveThreadDumpRes(TCmdActiveThreadDumpRes other) {
    if (other.isSetThreadDumps()) {
      java.util.List<TActiveThreadDump> __this__threadDumps = new java.util.ArrayList<TActiveThreadDump>(other.threadDumps.size());
  ...
  public void setThreadDumps(java.util.List<TActiveThreadDump> threadDumps) {
    this.threadDumps = threadDumps;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case THREAD_DUMPS:
      if (value == null) {
        ...
        setThreadDumps((java.util.List<TActiveThreadDump>)value);
      }
      break;
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCmdActiveThreadDumpRes(");
    boolean first = true;
  ...
  private static class TCmdActiveThreadDumpResStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCmdActiveThreadDumpResStandardScheme getScheme() {
      return new TCmdActiveThreadDumpResStandardScheme();
    }
  }

  private static class TCmdActiveThreadDumpResStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCmdActiveThreadDumpRes> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.threadDumps = new java.util.ArrayList<TActiveThreadDump>(_list72.size);
  ...
  private static class TCmdActiveThreadDumpResTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TCmdActiveThreadDumpResTupleScheme getScheme() {
      return new TCmdActiveThreadDumpResTupleScheme();
    }
  }

  private static class TCmdActiveThreadDumpResTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCmdActiveThreadDumpRes> {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.threadDumps = new java.util.ArrayList<TActiveThreadDump>(_list77.size);
