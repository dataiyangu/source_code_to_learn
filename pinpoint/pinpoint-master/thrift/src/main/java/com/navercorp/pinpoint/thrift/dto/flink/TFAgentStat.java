...
public class TFAgentStat implements org.apache.thrift.TBase<TFAgentStat, TFAgentStat._Fields>, java.io.Serializable, Cloneable, Comparable<TFAgentStat> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFAgentStatStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFAgentStatTupleSchemeFactory();

  private java.lang.String agentId; // optional
  ...
  private TFResponseTime responseTime; // optional
  private TFFileDescriptor fileDescriptor; // optional
  ...
  private static final _Fields optionals[] = {_Fields.AGENT_ID,_Fields.START_TIMESTAMP,_Fields.TIMESTAMP,_Fields.COLLECT_INTERVAL,_Fields.GC,_Fields.CPU_LOAD,_Fields.TRANSACTION,_Fields.ACTIVE_TRACE,_Fields.DATA_SOURCE_LIST,_Fields.RESPONSE_TIME,_Fields.FILE_DESCRIPTOR,_Fields.DIRECT_BUFFER,_Fields.METADATA};
  ...
  static {
    ...
    tmpMap.put(_Fields.RESPONSE_TIME, new org.apache.thrift.meta_data.FieldMetaData("responseTime", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFResponseTime.class)));
    tmpMap.put(_Fields.FILE_DESCRIPTOR, new org.apache.thrift.meta_data.FieldMetaData("fileDescriptor", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "TFFileDescriptor")));
    tmpMap.put(_Fields.DIRECT_BUFFER, new org.apache.thrift.meta_data.FieldMetaData("directBuffer", org.apache.thrift.TFieldRequirementType.OPTIONAL,
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFDirectBuffer.class)));
  ...
  public TFAgentStat(TFAgentStat other) {
    ...
    if (other.isSetDataSourceList()) {
      this.dataSourceList = new TFDataSourceList(other.dataSourceList);
    }
    if (other.isSetResponseTime()) {
      this.responseTime = new TFResponseTime(other.responseTime);
    }
    if (other.isSetFileDescriptor()) {
      this.fileDescriptor = new TFFileDescriptor(other.fileDescriptor);
    }
    if (other.isSetDirectBuffer()) {
      this.directBuffer = new TFDirectBuffer(other.directBuffer);
    }
  ...
  public void setResponseTime(TFResponseTime responseTime) {
  ...
  public void setFileDescriptor(TFFileDescriptor fileDescriptor) {
  ...
  public void setDirectBuffer(TFDirectBuffer directBuffer) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case RESPONSE_TIME:
      if (value == null) {
        ...
        setResponseTime((TFResponseTime)value);
      }
      break;
    ...
    case FILE_DESCRIPTOR:
      if (value == null) {
        ...
        setFileDescriptor((TFFileDescriptor)value);
      }
      break;
    ...
    case DIRECT_BUFFER:
      if (value == null) {
        ...
        setDirectBuffer((TFDirectBuffer)value);
      }
      break;
  ...
  public int compareTo(TFAgentStat other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGc()).compareTo(other.isSetGc());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGc()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCpuLoad()).compareTo(other.isSetCpuLoad());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCpuLoad()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetActiveTrace()).compareTo(other.isSetActiveTrace());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetActiveTrace()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetFileDescriptor()).compareTo(other.isSetFileDescriptor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFileDescriptor()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDirectBuffer()).compareTo(other.isSetDirectBuffer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDirectBuffer()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFAgentStat(");
    boolean first = true;
  ...
  private static class TFAgentStatStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFAgentStatStandardScheme getScheme() {
      return new TFAgentStatStandardScheme();
    }
  }

  private static class TFAgentStatStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFAgentStat> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TFAgentStat struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 60: // RESPONSE_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.responseTime = new TFResponseTime();
          ...
          case 80: // FILE_DESCRIPTOR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.fileDescriptor = new TFFileDescriptor();
          ...
          case 90: // DIRECT_BUFFER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.directBuffer = new TFDirectBuffer();
  ...
  private static class TFAgentStatTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFAgentStatTupleScheme getScheme() {
      return new TFAgentStatTupleScheme();
    }
  }

  private static class TFAgentStatTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFAgentStat> {
