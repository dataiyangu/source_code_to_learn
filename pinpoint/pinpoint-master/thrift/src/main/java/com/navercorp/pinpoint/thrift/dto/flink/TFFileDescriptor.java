...
public class TFFileDescriptor implements org.apache.thrift.TBase<TFFileDescriptor, TFFileDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<TFFileDescriptor> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFFileDescriptor");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFFileDescriptorStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFFileDescriptorTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFFileDescriptor.class, metaDataMap);
  }

  public TFFileDescriptor() {
  }
   ...
   */
  public TFFileDescriptor(TFFileDescriptor other) {
    __isset_bitfield = other.__isset_bitfield;
    this.openFileDescriptorCount = other.openFileDescriptorCount;
  }

  public TFFileDescriptor deepCopy() {
    return new TFFileDescriptor(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFFileDescriptor)
      return this.equals((TFFileDescriptor)that);
    return false;
  }

  public boolean equals(TFFileDescriptor that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFFileDescriptor other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOpenFileDescriptorCount()).compareTo(other.isSetOpenFileDescriptorCount());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFFileDescriptor(");
    boolean first = true;
  ...
  private static class TFFileDescriptorStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFFileDescriptorStandardScheme getScheme() {
      return new TFFileDescriptorStandardScheme();
    }
  }

  private static class TFFileDescriptorStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFFileDescriptor> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFFileDescriptor struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFFileDescriptor struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TFFileDescriptorTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFFileDescriptorTupleScheme getScheme() {
      return new TFFileDescriptorTupleScheme();
    }
  }

  private static class TFFileDescriptorTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFFileDescriptor> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFFileDescriptor struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFFileDescriptor struct) throws org.apache.thrift.TException {
