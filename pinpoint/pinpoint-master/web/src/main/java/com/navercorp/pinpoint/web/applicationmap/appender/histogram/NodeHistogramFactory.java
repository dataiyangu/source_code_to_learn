...
public interface NodeHistogramFactory {
    ...
    NodeHistogram createUserNodeHistogram(Application userApplication, Range range, LinkList linkList);

    NodeHistogram createQueueNodeHistogram(Application queueApplication, Range range, LinkList linkList);

    NodeHistogram createEmptyNodeHistogram(Application application, Range range);
}
