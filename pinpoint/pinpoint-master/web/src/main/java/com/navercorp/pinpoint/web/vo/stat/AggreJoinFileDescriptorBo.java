 ...
 * @author Roy Kim
 */
public class AggreJoinFileDescriptorBo extends JoinFileDescriptorBo implements AggregationStatData {
    ...
    public static AggreJoinFileDescriptorBo createUncollectedObject(long timestamp) {
        AggreJoinFileDescriptorBo aggreJoinFileDescriptorBo = new AggreJoinFileDescriptorBo();
        aggreJoinFileDescriptorBo.setTimestamp(timestamp);
